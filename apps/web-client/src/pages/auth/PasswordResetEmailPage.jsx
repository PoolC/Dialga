...
const PasswordResetEmailPage = () => {
  return (
    <>
      <Switch>
        <Route component={PasswordResetSuccess} path={`/${MENU.PASSWORD}/success/${MENU.RESET_PASSWORD}`} exact />
        <Route exact path={`/${MENU.PASSWORD}/success`} component={PasswordResetEmailSuccess} />
        <Route component={PasswordResetContainer} path={`/${MENU.PASSWORD}/${MENU.RESET_PASSWORD}`} exact />
        <Route component={PasswordResetEmailContainer} path={`/${MENU.PASSWORD}`} exact />
      </Switch>
    </>
  );
};

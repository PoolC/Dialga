...
const ApplyContainer = () => {
  ...
  if (isSubscriptionPeriod == null || (isSubscriptionPeriod === true && applyUri == null)) return null;

  return <Apply isSubscriptionPeriod={isSubscriptionPeriod} applyUri={applyUri} />;
};

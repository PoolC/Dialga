...
// 회원가입
export const register = ({ id, password, passwordCheck, name, email, department, studentId, phoneNumber, introduction, profileImageURL }) =>
  client.post('/member', {
    loginID: id,
    password,
    passwordCheck,
...
export const updateUser = ({ name, password, passwordCheck, email, phoneNumber, introduction, profileImageURL }) =>

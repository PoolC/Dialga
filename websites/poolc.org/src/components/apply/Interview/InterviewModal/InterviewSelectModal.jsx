...
const InterviewSelectModal = ({ date, startTime, endTime, visible, onConfirm, onCancel }) => {
  const contents = `${date} ${getHourMinuteString(startTime)}~${getHourMinuteString(endTime)}의 면접을 신청하시겠습니까?`;

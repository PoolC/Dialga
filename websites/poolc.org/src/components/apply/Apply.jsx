...
const Apply = ({ isSubscriptionPeriod, applyUri }) => (
  <Block>
    <WhiteBlock>
        ...
        {isSubscriptionPeriod && (
          <>
            <div>
              ...
              <br />
              안내 사항을 준수하지 않으신 경우, 선발 과정에서 불이익이 발생할 수 있습니다.
            </div>
            <div>
              <h4>1. 회원가입 및 로그인</h4>
              <br />
              PoolC 홈페이지에 <Highlighted>회원가입 후 로그인</Highlighted>을 해 주세요.
              <br />
              불합격 시, 결과 발표 후 일주일 내로 DB에서 회원 정보가 삭제됩니다.
            </div>
            <div>
              <h4>2. 면접 시간 제출</h4>
              <br />
              ...
              <br />
              가입 신청 마감 직전 트래픽 과부하가 발생할 수 있으므로 미리 신청해주세요.
              <br />
              가능한 시간이 없는 경우 회장 또는 플러스 친구에게 문의해주세요.
              <div>
                <ActionButton onClick={() => window.open('https://poolc.org/interview-time', '_blank')}>면접 시간 제출</ActionButton>
              </div>
            </div>
            <div>
              <h4>3. 지원서 제출</h4>
              ...
              <br />
              면접 시간 제출과 지원서 제출이 모두 완료되면 정상적으로 지원서 검토가 시작됩니다.
              <div>
                <ActionButton
                  onClick={() => {
                    if (applyUri) {

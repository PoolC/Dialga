...
import { IntervieweeInfo, IntervieweeList, StyledDateBlock, StyledTimeBlock, StyledTimeList, TimeBlockCapacity, TimeBlockId, TimeBlockTime } from './AdminInterview.styles';
  ...
  return (
    <IntervieweeList>
      <IntervieweeInfo>
        ...
        <div>
          <span className="admin-interview-label">학번 </span> {interviewee.studentID}
        </div>
        <div>
          <span className="admin-interview-label">학과 </span> {interviewee.department}
        </div>
        <div>
          <span className="admin-interview-label">연락처 </span> {interviewee.phoneNumber}
        </div>
      </IntervieweeInfo>
      <StyledDeleteButton onClick={onClickDelete}>면접 신청 취소</StyledDeleteButton>
    </IntervieweeList>
  );
};
